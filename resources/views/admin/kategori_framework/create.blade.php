...
@section('content')
<div class="mb-4">
    <h2 class="mb-1">Tambah Kategori Framework</h2>
...
<div class="card shadow-sm border-0">
    <div class="card-body p-4">
        <form action="{{ route('admin.kategori_framework.store') }}" method="POST">
            @csrf
            
            <div class="row mb-3">
                <div class="col-md-4">
                    <label for="kode" class="form-label fw-medium">Kode Kategori <span class="text-danger">*</span></label>
                    <input type="text" class="form-control @error('kode') is-invalid @enderror" id="kode" name="kode" value="{{ old('kode') }}" required maxlength="10">
                    @error('kode')
